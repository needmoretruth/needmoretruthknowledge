...
nmtk_i18n::messages! {
    ...
    PiecesSeven { en: "Four numbers on the right decide the model's shape, and they are worth naming.", ko: "오른쪽의 숫자 넷이 모델의 모양을 정합니다. 이름을 짚고 갈 만합니다." },
    ...
    BreakAfterWarmup { en: "At the sensible rate the ramp barely matters. At ten times it is the difference between the sentence and a misspelling of it.", ko: "적당한 학습률에서는 그 경사가 별 차이를 안 냅니다. 10배에서는 문장과 오타 사이의 차이가 됩니다." },
